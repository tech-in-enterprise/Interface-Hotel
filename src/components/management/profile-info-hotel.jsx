                    ...
                    <Box sx={{ flexGrow: 1, ml: 3 }} key={hotelData.id}>
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6}>
                                <TextField disabled label="Nome do Hotel" fullWidth variant="standard" value={hotelData.name} sx={{ m: 1 }} InputLabelProps={{ style: { fontSize: '0.9rem' }, shrink: true }} InputProps={{ readOnly: true }} />
                            </Grid>
                            <Grid item xs={12} sm={6}>
